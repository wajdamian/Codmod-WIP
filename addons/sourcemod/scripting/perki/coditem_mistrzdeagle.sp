...
new const String:nazwa[] = "Mistrz Deagle";
new const String:opis[] = "1/4 na instakill z Deagle.";
...
public Action:OnDealDamage(client, &attacker, &inflictor, &Float:damage, &damagetype)
{
	...
	if(StrEqual(weapon, "weapon_deagle") && GetClientButtons(attacker) & IN_ATTACK)
	{
