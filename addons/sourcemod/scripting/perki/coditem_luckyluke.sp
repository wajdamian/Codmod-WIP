...
new const String:nazwa[] = "Lucky Luke";
new const String:opis[] = "1/3 na natychmiastowe zabójstwo z rewolwera.";

new const String:bronie[] = "#weapon_revolver";
new bool:ma_item[65];
...
public Action:OnDealDamage(client, &attacker, &inflictor, &Float:damage, &damagetype)
{
	...
	if(StrEqual(weapon, "weapon_revolver") && GetClientButtons(attacker) & IN_ATTACK)
	{
