...
new const String:nazwa[] = "Krowa";
new const String:opis[] = "Dostajesz m249 oraz +10dmg z niego.";

new const String:bronie[] = "#weapon_m249";
new bool:ma_item[65];
...
public Action:OnDealDamage(client, &attacker, &inflictor, &Float:damage, &damagetype)
{
	...
	if(StrEqual(weapon, "weapon_m249") && damagetype & DMG_BULLET)
	{
		damage += 10.0;
