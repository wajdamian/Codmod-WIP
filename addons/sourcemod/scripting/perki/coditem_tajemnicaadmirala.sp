...
new const String:nazwa[] = "Tajemnica Admirala";
new const String:opis[] = "Dostajesz famas oraz +8dmg z niego.";

new const String:bronie[] = "#weapon_famas";
new bool:ma_item[65];
...
public Action:OnDealDamage(client, &attacker, &inflictor, &Float:damage, &damagetype)
{
	...
	if(StrEqual(weapon, "weapon_famas") && damagetype & DMG_BULLET)
	{
		damage += 80;
