...
new const String:nazwa[] = "Saper";
new const String:opis[] = "Ma trzy miny zadające 100dmg+ 1.5*int.";
new const String:bronie[] = "#weapon_p90#weapon_glock";
new const inteligencja = 0;
new const zdrowie = 10;
new const obrazenia = 0;
new const wytrzymalosc = 00;
...
public Action:DotykMiny(ent, client)
{
	...
	new damage = 100+RoundFloat(cod_get_user_maks_intelligence(attacker)*1.5);
